...
Smithing is a singular software development application for managing the full workflow in one place: coding, terminals, git diffs, browser-based work, workspaces, issues, PR review, and agent-assisted development.

## Core Concepts

- **Projects**: root directories, usually repositories, that Smithing can open and manage.
...
Smithing should reduce context switching and mental fatigue by making one application the home for the software development lifecycle.
